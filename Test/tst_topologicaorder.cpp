...
TEST(Test_Topological_Order, Normal) {

    // Create strategy
    BaseStrategy *currentStrategy = StrategyFactory().getStrategy(StrategyFactory::AllStrategies::Topologicalorder);
...
TEST(Test_Topological_Order, Disconnected_Graph) {
    // Create strategy
    BaseStrategy *currentStrategy = StrategyFactory().getStrategy(StrategyFactory::AllStrategies::Topologicalorder);
    StrategyContext context;
...
TEST(Test_Topological_Order, Lowest_Number_Of_Solutions) {
    // Create strategy
    BaseStrategy *currentStrategy = StrategyFactory().getStrategy(StrategyFactory::AllStrategies::Topologicalorder);
    StrategyContext context;
...
TEST(Test_Topological_Order, Infected_Vertex_Out_Of_Range) {
    // Create strategy
    BaseStrategy *currentStrategy = StrategyFactory().getStrategy(StrategyFactory::AllStrategies::Topologicalorder);
    StrategyContext context;
...
TEST(Test_Topological_Order, Multiple_sources_In_Same_Graph) {
    // Create strategy
    BaseStrategy *currentStrategy = StrategyFactory().getStrategy(StrategyFactory::AllStrategies::Topologicalorder);
    StrategyContext context;
    ...
    // Load data
    QString filePath = QDir::currentPath().append("/data/2_sources_in_same_graph.txt");
    GraphData *data = Repository().LoadFile(filePath).graphData;
    context.getStrategy()->setData(data);
...
TEST(Test_Topological_Order, No_Connections) {
    // Create strategy
    BaseStrategy *currentStrategy = StrategyFactory().getStrategy(StrategyFactory::AllStrategies::Topologicalorder);
    StrategyContext context;
...
TEST(Test_Topological_Order, No_Solutions) {
    // Create strategy
    BaseStrategy *currentStrategy = StrategyFactory().getStrategy(StrategyFactory::AllStrategies::Topologicalorder);
    StrategyContext context;
